...
Open `~/dropspace/apps/myapp/app.json` and fill in your event/community details. Set up Google Workspace credentials for Drive access (see `templates/dropspace-photo-slideshows/SETUP.md`).
