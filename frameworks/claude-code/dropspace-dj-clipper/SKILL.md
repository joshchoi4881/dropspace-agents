...
Open `~/dropspace/apps/myapp/app.json` and fill in your event/artist details. Set up Google Workspace credentials for Drive access if videos are on Drive (see `templates/dropspace-dj-clipper/SETUP.md`).
